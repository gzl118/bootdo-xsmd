...
public class ReportDeptCategoryServiceImpl implements ReportDeptCategoryService {
	...
	// @Override
	public int saveCategoryAndDepts(ReportDeptCategoryDO reportDeptCategory,
			Long[] deptIds) {
	...
	@Override
	public int removekb(Long rdc_id) {
		reportDeptCategoryDao.removekb(rdc_id);
		return reportDeptCategoryDao.remove(rdc_id);
	}
}
